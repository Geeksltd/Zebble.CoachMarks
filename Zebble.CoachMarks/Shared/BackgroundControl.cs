...
//        public BackgroundControl(View marksRook, string leftButtonText = "Skip", string rightButtonText = "Next")
//        {
//            Overlay = new Canvas
//            {
...
//            Stack.Width.BindTo(marksRook.Width);
//            Stack.Y.BindTo(marksRook.Height, Stack.Height, (rh, sh) => rh - sh);
